...
BASEFLAGS   += -Wl,--sysroot=$(SYSROOT) -std=c++11 -O0 -g -fpic -fdata-sections -Wa,--noexecstack -fsigned-char -Wno-psabi
WARNFLAGS   += -Wall
//WARNFLAGS   += -Werror
...
$(OUTPUTDIR)/VideoCapture.o   : $(SOURCEDIR)/VideoCapture.cpp $(INCLUDEDIR)/VideoCapture.h
